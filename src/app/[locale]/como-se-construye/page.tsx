import { Clapperboard, Phone } from "lucide-react";
    ...
    <div className="bg-[#F4F2EE] text-[#1A1C1E]">
      ...
      <main className="pt-16 pb-[58px] min-[1100px]:pt-[74px] min-[1100px]:pb-0">
        ...
        <section className="px-5 py-[52px] min-[900px]:mx-auto min-[900px]:max-w-[1200px] min-[900px]:px-10 min-[900px]:py-[88px]">
          <div className="flex flex-col items-center gap-4 rounded-2xl border-2 border-dashed border-[#D8D4C9] bg-white px-6 py-16 text-center min-[900px]:mx-auto min-[900px]:max-w-[720px]">
